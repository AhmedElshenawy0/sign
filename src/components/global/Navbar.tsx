...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-green-800 shadow-white/10 to-green-950 backdrop-blur-md shadow-md py-3 px-6 md:px-12">
